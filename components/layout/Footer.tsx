  ...
  return (
    <footer className="border-t border-gray-200 bg-white">
      <div className="mx-auto max-w-7xl px-6 py-16">
        {/* Top Section */}
        <div className="grid gap-4 md:grid-cols-2 md:gap-6 lg:grid-cols-4 lg:gap-5">
          {/* Brand */}
          <div>
            <Link href="/" className="text-3xl font-bold tracking-tight text-black">
              UrbanDrive
            </Link>
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <a
                ...
                className="rounded-full border border-gray-300 p-2.5 text-gray-700 transition hover:bg-black hover:text-white"
                aria-label="Facebook"
              >
