...
// Scaled down to two items using the smaller text configurations
const fleetData = [
  {
    id: '1',
  ...
  },
  {
    ...
    price: 350,
    image: 'https://images.unsplash.com/photo-1606016159991-dfe4f974be5c?auto=format&fit=crop&q=80&w=600',
...
export default function FeaturedFleet() {
  ...
  return (
    <section ref={sectionRef} className="py-16 md:py-24 max-w-[1440px] mx-auto px-5 md:px-16">
      ...
      {/* Centered grid container limiting expansion to max-w-5xl */}
      <div className="flex justify-center w-full mt-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl">
          {fleetData.map((car) => (
            <div 
              key={car.id} 
              className="fleet-card bg-white rounded-[24px] overflow-hidden border border-gray-100 shadow-sm transition-shadow hover:shadow-md flex flex-col group"
            >
              {/* Image Container using the custom 4:3 frame ratio */}
              ...
              {/* Added padding here: p-6 padding alignment layout */}
