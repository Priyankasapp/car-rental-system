...
export function normalizePermissionKey(permission: string): string {
  ...
  return VALID_PERMISSIONS.has(normalized as PermissionKey)
    ? normalized
    : permission;
}
    ...
    permissions: [
      {
        ...
        description: "Can view the main admin dashboard and summary metrics",
      },
    ],
  },
  {
    ...
    permissions: [
      {
        ...
        label: "View Cars",
        description: "Can view the car list and basic car details",
      },
      {
        key: PERMISSIONS.CARS_CREATE,
        label: "Create Cars",
        description: "Can add new cars to the inventory",
      },
      {
        key: PERMISSIONS.CARS_EDIT,
        label: "Edit Cars",
        description: "Can edit general car information",
      },
      {
        key: PERMISSIONS.CARS_DELETE,
        label: "Delete Cars",
        description: "Can delete cars from the system",
      },
    ],
  },
  {
    ...
    permissions: [
     {
      ...
      },
      {
        ...
        description: "Can add new car categories",
      },
      {
        key: PERMISSIONS.CATEGORIES_EDIT,
        label: "Edit Categories",
        description: "Can edit existing car categories",
      },
      {
        key: PERMISSIONS.CATEGORIES_DELETE,
        label: "Delete Categories",
        description: "Can remove car categories from the system",
      },
    ],
  },
  {
    ...
    permissions: [
      {
        key: PERMISSIONS.TRANSMISSIONS_VIEW,
        label: "View Transmission Types",
        description: "Can view transmission options",
      },
      {
        key: PERMISSIONS.TRANSMISSIONS_CREATE,
        label: "Create Transmission Types",
        description: "Can add new transmission types",
      },
      {
        key: PERMISSIONS.TRANSMISSIONS_EDIT,
        label: "Edit Transmission Types",
        description: "Can edit existing transmission types",
      },
      {
        key: PERMISSIONS.TRANSMISSIONS_DELETE,
        label: "Delete Transmission Types",
        description: "Can delete transmission types",
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      {
        key: PERMISSIONS.FUELS_CREATE,
        label: "Create Fuel Types",
        description: "Can add new fuel types",
      },
      {
        key: PERMISSIONS.FUELS_EDIT,
        label: "Edit Fuel Types",
        description: "Can edit existing fuel types",
      },
      {
        key: PERMISSIONS.FUELS_DELETE,
        label: "Delete Fuel Types",
        description: "Can delete fuel types",
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      {
        key: PERMISSIONS.FEATURES_CREATE,
        label: "Create Car Features",
        description: "Can add new features",
      },
      {
        key: PERMISSIONS.FEATURES_EDIT,
        label: "Edit Car Features",
        description: "Can edit car features",
      },
      {
        key: PERMISSIONS.FEATURES_DELETE,
        label: "Delete Car Features",
        description: "Can remove car features",
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        description: "Can add new service",
      },
      {
      ...
      },
      {
        ...
        description: "Can remove service",
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      {
        key: PERMISSIONS.RESERVATIONS_CREATE,
        label: "Create Reservations",
        description: "Can manually create bookings for customers",
      },
      {
        key: PERMISSIONS.RESERVATIONS_EDIT,
        label: "Edit Reservations",
        description: "Can update booking schedules or details",
      },
      {
        key: PERMISSIONS.RESERVATIONS_CANCEL,
        label: "Cancel Reservations",
        description: "Can cancel customer reservations",
      },
    ],
  },
  {
    ...
    permissions: [
      {
        ...
        label: "View Users",
        description: "Can view registered users and customer information",
      },
      {
    ...
    permissions: [
      {
        ...
        label: "View Staff",
        description: "Can view staff accounts and their assigned roles",
      },
      {
        key: PERMISSIONS.STAFF_CREATE,
        label: "Create Staff",
        description: "Can add new staff accounts",
      },
      {
        key: PERMISSIONS.STAFF_EDIT,
        label: "Edit Staff",
        description: "Can edit staff details and their assigned staff type",
      },
      {
        key: PERMISSIONS.STAFF_DELETE,
        label: "Remove Staff",
        description: "Can deactivate or remove staff accounts",
      },
    ],
  },
  {
    ...
    permissions: [
      {
        key: PERMISSIONS.STAFF_MASTER_VIEW,
        label: "View Staff Types",
        description: "Can view the staff role/type catalog",
      },
      {
        key: PERMISSIONS.STAFF_MASTER_CREATE,
        label: "Create Staff Types",
        description: "Can define new staff role templates",
      },
      {
        key: PERMISSIONS.STAFF_MASTER_EDIT,
        label: "Edit Staff Types",
        description: "Can edit an existing staff role template",
      },
      {
        key: PERMISSIONS.STAFF_MASTER_DELETE,
        label: "Delete Staff Types",
        description: "Can remove a staff role template",
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        description: "Can grant or revoke another staff member's permissions",
      },
    ],
  },
  // {
