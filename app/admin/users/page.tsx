...
const UserRoleBadge = ({ role }: { role: string }) => {
  ...
  return (
    <span className={`inline-flex px-3 py-1 text-xs font-medium rounded-full border ${styles[normalizedRole] || styles.CUSTOMER}`}>
...
export default function AdminUsersPage() {
  ...
  useEffect(() => {
    ...
    if (isAllowed && !hasInitialized.current) {
  ...
  // Safe Case-Insensitive Client Search Filtering
  ...
  // Loading state
  if (authLoading || (isLoading && !hasInitialized.current)) {
    return (
    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage registered customer accounts and permissions
          </p>
        </div>
        <Link
      ...
      {filteredUsers.length === 0 && !isLoading ? (
        ...
        <div className="text-center py-12 bg-white border border-gray-200 rounded-xl">
          ...
          <p className="text-sm text-gray-500 mt-1">
            {searchTerm ? 'Try adjusting your search query' : 'No registered customer accounts available.'}
          </p>
        </div>
      ) : (
        /* Users Grid */
            ...
            >
              <div>
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="flex items-center gap-4 pt-2 border-t border-gray-100">
                    ...
                    <div className="text-center flex-1">
                      <p className="text-lg font-semibold text-gray-900">{u._count?.payments || 0}</p>
              ...
              <div className="px-4 py-3 bg-gray-50 border-t border-gray-200 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  title={u.id === user.id ? "You cannot delete yourself" : "Delete customer"}
                >
                  {deletingId === u.id ? (
